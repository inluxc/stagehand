            ...
            var setRequestParam = function (name, value, type) {
                switch (type) {
                    ...
                    case client_1.ParamType.Query: {
                        ...
                        var param = parameters.find(function (p) { return p.name === name && p.in === 'query'; });
                        var serialized = (0, query_serializer_1.serializeQueryParameter)(param, name, value);
                        queryStringParts.push.apply(queryStringParts, __spreadArray([], __read(serialized), false));
                        break;
                    }
